...
class FaceGenerateChallengeClient extends GenerateChallengeClient<IFaceService> {
    ...
    private static final BaseClientMonitor.Callback EMPTY_CALLBACK =
    ...
    FaceGenerateChallengeClient(Context context,
                                HalClientMonitor.LazyDaemon<IFaceService> lazyDaemon,
                                IBinder token, ClientMonitorCallbackConverter listener,
                                int userId, String owner, int sensorId, long now) {
        ...
        try {
            try {
                ...
                for (IFaceServiceReceiver receiver : mWaiting) {
                    sendChallengeResult(new ClientMonitorCallbackConverter(receiver),
                            EMPTY_CALLBACK);
                }
    ...
    private void sendChallengeResult(ClientMonitorCallbackConverter receiver,
                                     BaseClientMonitor.Callback ownerCallback) {
